...
class ElementsTest < ApplicationSystemTestCase
  ...
  test "creating a Element" do
    ...
    fill_in "Created on", with: @element.created_on
    fill_in "Description", with: @element.description
    fill_in "Itemart", with: @element.itemart
    fill_in "Name", with: @element.name
    check "Pointsreceived" if @element.pointsreceived
    check "Reviewed" if @element.reviewed
    fill_in "Reviewed on", with: @element.reviewed_on
    fill_in "Updated on", with: @element.updated_on
    fill_in "User", with: @element.user_id
