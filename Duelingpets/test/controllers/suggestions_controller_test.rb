...
class SuggestionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create suggestion" do
    assert_difference('Suggestion.count') do
      post suggestions_url, params: { suggestion: { created_on: @suggestion.created_on, description: @suggestion.description, title: @suggestion.title, updated_on: @suggestion.updated_on, user_id: @suggestion.user_id } }
    end
  ...
  test "should update suggestion" do
    patch suggestion_url(@suggestion), params: { suggestion: { created_on: @suggestion.created_on, description: @suggestion.description, title: @suggestion.title, updated_on: @suggestion.updated_on, user_id: @suggestion.user_id } }
