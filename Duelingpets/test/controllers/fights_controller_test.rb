...
class FightsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create fight" do
    assert_difference('Fight.count') do
      post fights_url, params: { fight: { draw: @fight.draw, loss: @fight.loss, partner_id: @fight.partner_id, win: @fight.win } }
    end
  ...
  test "should update fight" do
    patch fight_url(@fight), params: { fight: { draw: @fight.draw, loss: @fight.loss, partner_id: @fight.partner_id, win: @fight.win } }
