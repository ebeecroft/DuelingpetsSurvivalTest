...
class ItemtypesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create itemtype" do
    assert_difference('Itemtype.count') do
      post itemtypes_url, params: { itemtype: { basecost: @itemtype.basecost, created_on: @itemtype.created_on, demoitem: @itemtype.demoitem, dreyterriumcost: @itemtype.dreyterriumcost, name: @itemtype.name } }
    end
  ...
  test "should update itemtype" do
    patch itemtype_url(@itemtype), params: { itemtype: { basecost: @itemtype.basecost, created_on: @itemtype.created_on, demoitem: @itemtype.demoitem, dreyterriumcost: @itemtype.dreyterriumcost, name: @itemtype.name } }
