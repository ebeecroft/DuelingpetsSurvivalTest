...
class ReferralsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create referral" do
    assert_difference('Referral.count') do
      post referrals_url, params: { referral: { created_on: @referral.created_on, referred_by_id: @referral.referred_by_id, user_id: @referral.user_id } }
    end
  ...
  test "should update referral" do
    patch referral_url(@referral), params: { referral: { created_on: @referral.created_on, referred_by_id: @referral.referred_by_id, user_id: @referral.user_id } }
